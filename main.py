...
async def command_start(message: Message):
    ...
    if user:  # Есть ли что-то в переменной?
        ...
        text = f"""Здравствуйте, {message.from_user.full_name} вас привествуйет [Название бренда]
...
Меню ''', reply_markup=generate_categories_menu(categories))
...
async def show_products(call: CallbackQuery):
    ...
    await bot.edit_message_text(text='Выберите вкус: ',
